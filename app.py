...
with st.form("input_form"):
    ...
    # Pre-filled values
    N = st.number_input("Nitrogen (N)", min_value=0, max_value=200, value=108)
    P = st.number_input("Phosphorous (P)", min_value=0, max_value=200, value=38)
    K = st.number_input("Potassium (K)", min_value=0, max_value=200, value=24)

    temperature = st.number_input("Temperature (°C)", min_value=0.0, max_value=45.0, value=38.0, step=0.01)
    humidity = st.number_input("Humidity (%)", min_value=0.0, max_value=100.0, value=68.0, step=0.01)
    ph = st.number_input("Soil pH", min_value=0.0, max_value=10.0, value=6.5, step=0.01)
    rainfall = st.number_input("Rainfall (mm)", min_value=0.0, max_value=300.0, value=62.0, step=0.01)
